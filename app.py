...
def get_emojis():
    """ Get the suggested emojis based on the current emotion and vector measures. """
...
def set_model():
    """ Set the model type to be used for emotion detection. """
...
def upload_image():
    """ Process the uploaded image and detect the emotion. """
...
def set_mode():
    """ Set the current mode to either 'Camera' or 'Upload'. """
